    ...
    <div class="container">
             <div class="row">
                ...
                <div class="col-md-12 col-lg-8">
                    ...
                    <h3 class="mtb-30">Colok Naga</h3>
                    <p class="mt-15">Cara kerja seperti colok bebas 2D tapi mesti yang keluar 3 angka dari 4D.</p>
                    ...
                    <p class="mt-15">Analisis I:<br/>
                            ...
                            100rb + [Indeks kemenangan untuk colok naga , kategori: 3 digit]</p>
                    <p class="mt-15">Analisis II:<br/>
                            ...
                            Nilai betting tidak dikembalikan</p>

                    <p class="mt-15">Analisis III:<br/>
                            Keluar : 4331<br/>
                            Misalnya dibeli 4,3 dan 3 dengan nilai 100rb.<br/>
                            Berarti menang:<br/>
                            Karena keluar 3 digit,angka 4,3 dan 3.<br/>
                            100rb + [Indeks kemenangan untuk colok naga , kategori: 3 digit]</p>

                    <p class="mt-15">Analisis IV:<br/>
                            Keluar : 4334<br/>
                            Misalnya dibeli 4,3 dan 3 dengan nilai 100rb.<br/>
                            Karena keluar 4 digit,angka 4,3 dan 3.<br/>
                            Berarti menang:<br/>
                            100rb + [Indeks kemenangan untuk colok naga, kategori: 4 digit]</p>
